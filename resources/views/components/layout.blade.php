...
<head>
    ...
    <meta name="description"
        content="Amity University provides world-class education in diverse streams including engineering, management, medical and others. Visit our campus to know more." />
    <meta name="keywords"
        content="Universities in delhi ncr, best university in noida, noida university, private universities in delhi ncr, best universities in delhi ncr, Amity University" />
    <title>
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                ...
                $.each(customers, function() {
                    ...
                    list.append('<li onClick="graduate($(this))" id="' + row + '" >' + $(this).find(
                        "CourseFullname").text() + '</li>');
                });
            } else {
                $('#courselist li').remove();
                $("#courselist").removeAttr("style");
        ...
        function OnSuccessPost(response) {
            ...
            if (customers.length > 0) {
                ...
                $.each(customers, function() {
                    ...
                    list.append('<li onClick="postgraduate($(this))" id="' + row + '" >' + $(this).find(
                        "CourseFullname").text() + '</li>');
                });
            } else {
                $('#postcourselist li').remove();
